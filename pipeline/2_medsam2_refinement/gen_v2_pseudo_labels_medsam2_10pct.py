...
SAM2_CKPT = "/root/autodl-tmp/MedSAM2/checkpoints/MedSAM2_CTLesion.pt"  # MedSAM2
...
SELECTION = "/root/autodl-tmp/v5_3d_pseudo_label_selection.json"
OUT_LABELS = Path("/root/autodl-tmp/sam2_v5_3d/medsam2_pseudo_labels_10pct")
OUT_JSON = "/root/autodl-tmp/sam2_v5_3d/medsam2_pseudo_label_quality_10pct.json"
...
def main():
    ...
    cases = json.load(open(SELECTION))["pseudo_label_case_ids"]
