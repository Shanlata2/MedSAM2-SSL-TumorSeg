...
V3_DIR = Path("/root/autodl-tmp/predictions/liver_sup5_on_unlabeled95")
SPLIT = "/root/autodl-tmp/lits_ssl_split.json"
OUT_LABELS = Path("/root/autodl-tmp/lits_build/liver_medsam2_pseudo_labels_5pct")
OUT_JSON = "/root/autodl-tmp/lits_build/liver_medsam2_pseudo_label_quality_5pct.json"
...
def main():
    ...
    cases = json.load(open(SPLIT))["unlabeled_5pct"]
